# BarberTime — API + App Cliente (Sprint 3)

Backend **Node.js + Express**, **PostgreSQL**, **JWT** e **RabbitMQ** (MOM) para o domínio de agendamento em barbearia. **Sprint 3:** app Flutter cliente em `mobile_client/`.
