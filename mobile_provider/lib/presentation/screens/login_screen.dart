...
/// Login do prestador. Diferente do app cliente, não há cadastro aqui — as
/// contas de barbeiro são provisionadas no backend (seed ou `POST /barbers/register`).
